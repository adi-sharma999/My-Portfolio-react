            ...
            <div className="w-full flex flex-col justify-center items-center md:p-4 gap-4 md:gap-5">
                ...
                <div className="space-y-10 md:space-y-0">
                    ...
                    <div className="w-full flex flex-col text-xs sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl md:px-10 md:py-10 md:gap-x-10 md:gap-y-0">
                        ...
                        <div className="flex justify-center md:justify-end items-center">
                            <button onClick={() => window.open("https://my-portfolio-app999.netlify.app/", "_blank")} className="text-red-500 text-[7.5px] px-1.5 py-0.5 md:text-xl border-1 rounded-full md:px-4 md:py-2 hover:text-white transition-all duration-300 origin-left cursor-pointer">
                                View My-Portfolio
                            </button>
                        </div>
                    </div>
